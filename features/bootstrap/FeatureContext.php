...
class FeatureContext implements Context, SnippetAcceptingContext
{
    ...
    {
        if (is_dir($dir = sys_get_temp_dir() . DIRECTORY_SEPARATOR . 'behat-formatter-teamcity')) {
    ...
    {
        $dir = sys_get_temp_dir() . DIRECTORY_SEPARATOR . 'behat-formatter-teamcity' . DIRECTORY_SEPARATOR .
